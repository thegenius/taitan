...
impl<A, B> Service<Request<HttpBoxBody>> for MultiplexService<A, B>
where
    A: Service<Request<HttpBoxBody>, Error = Infallible>,
    A::Response: IntoResponse,
    A::Future: Send + 'static,
    B: Service<Request<HttpBoxBody>>,
    ...
    B::Future: Send + 'static,
{
    ...
    fn call(&mut self, req: Request<HttpBoxBody>) -> Self::Future {
